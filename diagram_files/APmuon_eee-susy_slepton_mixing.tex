...
\begin{fmffile}{APmuon_eee-susy_slepton_mixing}
\begin{fmfgraph*}(150,80)
    ...
    % loop content
    \fmfi{dashes}{p1}
    \fmfi{dashes}{subpath (0,1/6length(p2)) of p2}
    \fmfiv{label=\HepProcess{\PSmu\leftrightarrow\PSe},d.shape=cross,d.size=5thick}{point 2/5length(p1) of p1}
    \fmfi{fermion,label=\PSneutralino}{subpath (1/6length(p2),length(p2)) of p2}
\end{fmfgraph*}
\end{fmffile}
